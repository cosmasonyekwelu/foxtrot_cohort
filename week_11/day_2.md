Below is your corrected **Week 11 – Day 2 README**, rewritten in the same format as Day 1, with the sections you asked **removed**, and replaced with:

* JSON examples for creating the new test user
* Login request example
* Creating the new **current** account
* Testing Swagger documentation for login

No deposit/transfer logic sections are included since they were from Day 1.

This is the clean, final, Day-2-only version.
